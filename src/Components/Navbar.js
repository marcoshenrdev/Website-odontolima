        ...
        return (
            <div className='container-fluid p-0'>
                <nav className="navbar navbar-expand-md w-100">
                    <a href="../" className="navbar-brand" style={{  color: 'white' }}><img src="https://imgur.com/kJciBzv.png" href="../"></img></a>
                    ...
                    <div className="navbar-nav collapse navbar-collapse" id="navbarMainToggler">
                        ...
                        <a href="../atendimentodeemergencia" class="btn btn-danger text-white border-light ml-3" role="button" aria-pressed="true"><i className="fas fa-exclamation-triangle"></i>&nbsp;Atendimento de Emergência</a>
                    </div>
